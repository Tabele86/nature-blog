	...
	return (
		<main className="bg-green-600 min-h-screen p-12">
			<section className="container mx-auto">
				<h1 className="text-green-100 text-5xl flex justify-center cursive">Blog Posts Page</h1>
				<h2 className="text-lg text-green-100 flex justify-center mb-12">Welcome to my page of blog posts</h2>
